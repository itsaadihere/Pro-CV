...
export default function KarachiCVBuilderPage() {
  return (
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            >
              <span>🇵🇰 Specifically Optimized for Karachi Job Market</span>
            </motion.div>
            
            <h1 className="text-4xl font-black tracking-tight text-slate-900 sm:text-5xl leading-[1.1]">
              Professional AI CV Builder in Karachi
            </h1>
            
            <p className="text-lg text-slate-600 leading-relaxed">
              Applying for jobs at corporate headquarters in I.I. Chundrigar Road or tech firms in Shahrah-e-Faisal? Make sure your CV gets past their digital HR filters. Sophi uses AI to rewrite your CV specifically for Karachi's highly competitive job market.
            </p>
          ...
          <div className="relative">
            ...
            <img 
              ...
              alt="Professional CV Builder Karachi" 
